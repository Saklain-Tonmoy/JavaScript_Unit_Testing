...
(u.prototype = {
  ...
  (u.prototype.args = function (t, e, n) {
    return (t =
      "string" != typeof (t = "function" == typeof t ? t(e, n) : t)
        ? this.slice(t).map(this.str(e, n))
        : t)
      .toString()
      .split(/[\s,]+/)
      .filter(function (t) {
  ...
  (u.prototype.array = function (o) {
    ...
    return this.nodes.reduce(function (t, e, n) {
      ...
      return (
        o
          ? (r =
              "string" == typeof (r = (r = o.call(i, e, n)) || !1)
                ? u(r)
  ...
  (u.prototype.on = function (t, e, o) {
      ...
      (e = function (n) {
        ...
        u(n.currentTarget)
          ...
          .each(function (t) {
            var e;
            t.contains(n.target) &&
              ((e = n.currentTarget), i(n, t), o.apply(t, r), i(n, e));
          });
      }));
    function r(t) {
    ...
    return this.eacharg(t, function (t, e) {
      t.addEventListener(e, r),
        (t._e = t._e || {}),
        (t._e[e] = t._e[e] || []),
        t._e[e].push({ callback: r, orig_callback: n, selector: c });
    });
  }),
...
const getItem = () =>
  fetch("language.json")
    ...
    .catch(err => u('.lang-grid__nodata').removeClass('hide'));

const triggerItem = () => {

  u('.lang-grid--trans').each(function (node, i) {
      if(u(node).hasClass('hide')) {
...
u('#disable').on('click', triggerItem);
